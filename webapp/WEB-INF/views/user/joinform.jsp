	...
	<div class="contentwrap">
	  <article class="container">
	    <div class="page-header">
		  <h3>이미지 등록 <small>계정 이미지 업로드</small></h3>
	    </div>
	    <form class="form-horizontal" id="join-form" name="joinForm" method="post" action="/upa/user/join" enctype="multipart/form-data" style="margin-bottom: 100px;">
	     <!-- 이미지 삽입 -->
