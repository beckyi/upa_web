				...
				<form id="id-form" name="idForm" method="post"
					...
					<table class="tbl_wtype1 smaller">
						<tbody>
							<tr>
								<th scope="row">이름</th>
								<td><input id="name" name="name" type="text" value="" style="padding-left: 8px;"></td>
							</tr>
							<tr>
								<th scope="row">휴대폰</th>
								<td><input id="phone" name="phonenum" type="text" value=""	placeholder="'-'제외하고 숫자만 입력" style="padding-left: 8px;"></td>
							</tr>
						</tbody>
					</table>
					<input class="btn btn-find" id="findid" type="submit" value="아이디찾기" style="margin-top: 112px;">
				</form>
			</div>
				...
				<form id="password-form" name="passForm" method="post">
					<table class="tbl_wtype1 smaller">
						<tbody>
							<tr>
								<th scope="row">아이디</th>
								<td><input id="id1" name="id" type="text" value="" style="padding-left: 8px;"></td>
							</tr>
							<tr>
								<th scope="row">이름</th>
								<td><input id="name1" name="name" type="text" value="" style="padding-left: 8px;">
								</td>
							</tr>
							<tr>
								<th scope="row">휴대폰</th>
								<td><input id="phone1" name="phonenum" type="text" value="" placeholder="'-'제외하고 숫자만 입력" style="padding-left: 8px;"></td>
							</tr>
						</tbody>
					</table>
